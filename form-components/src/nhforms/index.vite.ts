/**
 * NHForms Components Auto-Loader (Vite version)
 *
 * Uses Vite's import.meta.glob for automatic component discovery.
 * This file is used when building with Vite.
 *
...
function loadComponentCode(code: string, componentName: string, additionalComponents: Record<string, any> = {}): Record<string, any> {
  ...
  try {
    ...
    //   console.log(`Loaded NHForms component ${componentName}:`, Object.keys(result));
    // }
